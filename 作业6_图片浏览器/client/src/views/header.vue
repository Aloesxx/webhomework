            ...
            <e-container class="clearfix">
                ...
                <div class="header-nav-ul nav-left clearfix">
                    <ul class="header-nav-left clearfix">
                        ...
                        <li v-for="m in listMenuzhaopianfenlei">
                            <router-link :to="'/zhaopianxinxi?fenlei='+m.id" v-text="m.fenleimingcheng"></router-link>
                        </li>
                        <li>
                            <router-link to="/yonghuadd">注册 </router-link>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            searchKeyword() {
                var filter = {};
                filter["zhaopianmingcheng"] = this.keyword;
                this.$router.push({
                    path: "/zhaopianxinxi",
                    query: filter,
                });
        ...
        created() {
            this.loadListMenu("zhaopianfenlei", "listMenuzhaopianfenlei");
        },
        mounted() {},
        destroyed() {},
    };
